...
if __name__ == '__main__':
    f_read = open("prepare_transcript/dictionary/data_merger/dict.txt", "r", encoding="UTF-8")
    dict_full = []
    ...
    f_write = open("prepare_transcript/dictionary/data_merger/dict_2.txt", "w+", encoding="UTF-8")
